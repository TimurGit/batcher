...
| `--batch-size` | `10000` | значений ключа в окне |
| `--jobs` | `1` | параллельных окон |
| `--stmt-timeout-ms` | `60000` | `statement_timeout` на окно (`0` — без лимита) |
| `--sleep` | `3` | пауза после каждого окна, сек (`0` — гнать вплотную) |
